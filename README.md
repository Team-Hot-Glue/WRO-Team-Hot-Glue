...
Here you will find all the code and CAD files for our robot, as well as the engineering journal that dives into how we made it.
...
**3)** Order the necessary electronic components from your local electronics components shop. The full list and rellevant links can be found **IN THE ENGINEERING JOURNAL**
